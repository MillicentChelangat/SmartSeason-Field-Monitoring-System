...
def register_user(email, password, full_name, role='field_agent'):
    """Create a new user and profile. Raises ValueError on bad input."""
...
def login_user(email, password):
    """Authenticate and return (user, profile). Raises ValueError on failure."""
