import {
  ...
  FileText, Settings, HelpCircle, LogOut, X,
} from 'lucide-react';
...
export function AdminSidebar({ activePage, onNavigate, onLogout, user, fieldCount, agentCount, onClose }: Props) {
  return (
      ...
      <nav style={{ flex: 1, overflowY: 'auto', padding: '12px' }}>
        {(['menu', 'reports', 'system'] as const).map(section => (
          <div key={section} style={{ marginBottom: 8 }}>
            <p style={{ fontSize: 10, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: 1.3, padding: '10px 8px 4px', fontWeight: 600, margin: 0 }}>
              {section}
            </p>
